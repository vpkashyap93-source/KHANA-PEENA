...
function ReportsPage({ orders, inventory, expenses = [], parties = [], partyTransactions = [], paymentTransactions = [], purchases = [], suppliers = [], profile, capitalTransactions = [], addCapitalTransaction }) {
  ...
  const netGstPayable = totalGst - totalInputGst
  ...
  const exportToExcel = async () => {
    ...
    addSheet('Summary', [
      ...
      ['Total expenses', totalExpenses], ['Net profit', netProfit], ['GST collected (Output)', totalGst], ['Input GST (ITC)', totalInputGst], ['Net GST payable', netGstPayable], ['Discount given', totalDiscount],
  ...
  return <>
    ...
    <div className="summary-grid">
      ...
      <article className="summary-card"><span>Input GST (ITC)</span><strong>{money(totalInputGst)}</strong></article>
      <article className="summary-card"><span>Net GST payable</span><strong className={netGstPayable > 0 ? 'accounting-due' : 'accounting-paid'}>{money(netGstPayable)}</strong></article>
